 ...
 * Use the {@link WhatsNew#newInstance} factory method to
...
public class WhatsNew extends Fragment {
     ...
     * @return A new instance of fragment WhatsNew.
     */
    // TODO: Rename and change types and number of parameters
    public static WhatsNew newInstance(String param1, String param2) {
        WhatsNew fragment = new WhatsNew();
    ...
    private void Productsetter(final View view)
    {
        ...
        Call<Product> retrofitcall = retrofitinterface.getWhatsnewlist(MyApp.getBase_url()+"api/"+"whatsnew");
